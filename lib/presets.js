...
async function showPresetList() {
  ...
  availablePresets.forEach((preset) => {
    ...
    preset.extensions.forEach((extension) => {
      console.log('  \u2022 ' + `${greenTextColor}${extension}${resetTextColor}`);
    })
  });
  console.log("\n");
}
...
export { addPreset, deletePreset, showPresetList, getAvailableExtensions };
